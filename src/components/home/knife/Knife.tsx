...
export function Knife({ throwRef }: any) {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(knifeRef.current, { rotation: 100, scale: .5, x: '45vw', y: '200vh', }, { delay: 1.5, duration: .1, scrollTrigger: { end: 'center -10%', start: 'center 110%', toggleActions: 'play reset play reset', trigger: throwRef.current, }, x: '55vw', y: '10vh', })
	})
