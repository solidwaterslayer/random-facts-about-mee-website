...
export default function Fact({ text }: any) {
  ...
  useEffect(() => {
    ...
    gsap.from(factRef.current, { opacity: 0, scrollTrigger: { end: 'center 60%', markers: true, start: 'center 90%', scrub: true, trigger: factRef.current, toggleActions: 'play none none none', }, })
  })
