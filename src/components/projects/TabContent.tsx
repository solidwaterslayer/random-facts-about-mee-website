...
export function TabContent({ eventKey, text, link }: any) {
  return (
    <Tab.Pane className='hover-activator' eventKey={ eventKey }>
      <h1 className='h-line-height hover-target text-danger'>Overview</h1>
      <p className='hover-target p-line-height text-light'>
        { text }
      </p>

      <h2 className='h-line-height hover-target text-danger'>Running Instance | Link To Project</h2>
