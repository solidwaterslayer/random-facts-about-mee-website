...
export function Snowflake({ winterRef }: any) {
  ...
  useEffect(() => {
    ...
    gsap.from(snowflakeRef.current, { opacity: 0, scrollTrigger: { end: 'center 60%', start: 'center 90%', scrub: true, trigger: winterRef.current, toggleActions: 'play pause play pause', }, })
	})
